...
--
-- Host: localhost
-- Generation Time: Nov 11, 2014 at 07:14 PM
...
-- Database: `cantus`
--
CREATE database IF NOT EXISTS cantus;
use cantus;
-- --------------------------------------------------------
...
INSERT INTO `artists` (`aKey`, `Name`, `GroupId`, `Instrament`, `Birth`, `Death`) VALUES
...
INSERT INTO `users` (`user_id`, `username`, `password`, `email`, `libraryNum`) VALUES
(2, 'NEW_NAME', 'NEW_PASSWO', NULL, 0);
...
--
ALTER TABLE `artists`
MODIFY `aKey` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
